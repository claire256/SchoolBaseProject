    ...
    return(
        <div className="container">
            ...
            <h1 className="h1">Create your account</h1>
                ...
                <div className="form-display">
                    <div>
                    <label for="Residential Address">Residential Address</label><br></br>
                    <input id="Residential Address" placeholder="Residential Address"/>
                    </div>
                    <div className="state">
                    <label for="Date of Birth">Date of Birth</label><br></br>
                    <input id="Date of Birth" placeholder="Date of Birth"/><img src={Arrowdown} className="arrow"/>
                    </div>
                </div><br></br>
                <div className="form-display">
                    <div className="state">
                    <label for="State">State</label><br></br>
                    <input id="State" placeholder="State"/><img src={Arrowdown} className="arrow"/>
                    </div>
                    <div className="state">
                    <label for="City">City</label><br></br>
                    <input id="City" placeholder="City" /><img src={Arrowdown} className="arrow"/>
                    </div>
                </div><br></br>
                <div className="form-display">
                    <div>
                    ...
                    <div>
                    <label for="Comfirm Password">Comfirm Password</label><br></br>
                ...
                <div className="last-sec">
                    ...
                    <div className="state">
                    <button className="file">select from file</button><img src={imageicon} className="image-icon"/>
                    </div>
                </div>
                <button className="button">Sign Up</button>
                <p className="login">Already have an account? <Link to="/" className="link">Login</Link></p>
            </form>
            </div>
        </div>
    )
