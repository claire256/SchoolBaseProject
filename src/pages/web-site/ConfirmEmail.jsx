...
const ConfirmEmail = () => {
  return (
    <div className="bg-blueBg h-screen relative">
      ...
      <div className="font-manrope text-center py-20 text-xs bg-white border-black m-auto w-3/4 rounded-3xl shadow-2xl lgss:w-3/5">
        ...
        >
          ...
          >
            After OTP verification <FaArrowCircleRight />
          </button>
        </Link>
      </div>
      <div>
