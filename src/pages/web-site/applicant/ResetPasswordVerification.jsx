  ...
  return (
    <div className="bg-blueBg h-screen relative">
      ...
      <div className="font-manrope text-center py-24 text-xs bg-white border-black m-auto w-3/4 rounded-3xl shadow-2xl lgss:w-3/5">
        ...
        {/* =================== Temporary ========================== */}
        <Link className="flex justify-center items-center w-full" to={"/new-password"}>
          <button href="" className="bg-primary rounded-full py-4 px-4 text-white text-[18px] flex gap-5">After reset password <FaArrowCircleRight/></button>
        </Link>
      </div>
      <div>
        <img
