    ...
    <div className="flex flex-row h-screen">
      ...
      <div className="lgss:w-4/5 w-full lgss:overflow-auto">
        ...
        <div className="left-div">
          <br></br>
          <Content title="Subject Information" image={ArrowLeft} />
          <br></br>
          <br></br>
          <Content title="Groups" image={ArrowLeft} />
          <br></br>
        </div>
        ...
        <div className="left-div">
          <br></br>
          <Content title="Week 1" image={ArrowLeft} />
          <br></br>
          <br></br>
          <Content title="Week 2" image={ArrowLeft} />
          <br></br>
          <br></br>
          <Content title="Week 3" image={ArrowLeft} />
          <br></br>
          <br></br>
          <Content title="Week 4" image={ArrowLeft} />
          <br></br>
        </div>
        <hr className="horizontal" />
        <div className="division-display">
        ...
        <div className="left-div">
          <br></br>
          <Content title="Assessment Information" image={ArrowLeft} />
          <br></br>
          <br></br>
          <Content title="Submission Link" image={redirect} />
          <br></br>
          <br></br>
          <Content title="Take Quiz" image={redirect} />
          <br></br>
        </div>
        <hr className="horizontal" />
      </div>
